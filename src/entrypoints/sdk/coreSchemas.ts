  ...
  z
    .object({
      ...
      apiProvider: z
        ...
        .optional()
        .describe(
          'Active API backend. Anthropic OAuth login only applies when "firstParty"; for third-party providers the other fields are absent and authentication is external.',
        ),
    })
